 ...
 * when scrolling.
 */
public class SlidingTabsPlayRecoFragment extends Fragment {
    ...
    static class PlayListPagerItem implements PagerItem{
        private final CharSequence mTitle;
        private final int mIndicatorColor;
        private final int mDividerColor;

        PlayListPagerItem(CharSequence title, int indicatorColor, int dividerColor) {
            mTitle = title;
            mIndicatorColor = indicatorColor;
            mDividerColor = dividerColor;
        }
         ...
         */
        public Fragment createFragment() {
            return PlaylistFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
        }
    ...
    static class RecommendationPagerItem implements PagerItem{
        private final CharSequence mTitle;
        private final int mIndicatorColor;
        private final int mDividerColor;

        RecommendationPagerItem(CharSequence title, int indicatorColor, int dividerColor) {
            mTitle = title;
            mIndicatorColor = indicatorColor;
            mDividerColor = dividerColor;
        }
         ...
         */
        public Fragment createFragment() {
            return RecommendationsFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
        }
...
//        ));
        ...
        mTabs.add(new PlayListPagerItem(
                getString(R.string.tab_playlist), // Title
                Color.RED, // Indicator color
                Color.GRAY // Divider color
        ));

        mTabs.add(new RecommendationPagerItem(
                getString(R.string.tab_recomendations), // Title
