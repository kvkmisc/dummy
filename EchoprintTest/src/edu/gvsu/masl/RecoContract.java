...
public class RecoContract {
	 
	 /**
	  * Singleton instance
	  */
	 private RecoContract() { 
	  ...
	  */                                                                                             
	 public static final String CONTENT_AUTHORITY = "com.provider";          
	                                                                                                 
	 /**                                                                                             
	  * Base URI. (content://com.provider)                                   
	  */                                                                                             
	  ...
	  */                                                                                             
	 private static final String PATH_ENTRIES = "recoEntries";                                           
